...
import { platforma } from "@platforma-open/milaboratories.vj-usage.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type VjUsageBlockContract = BlockContract;
export type VjUsageBlockOutputs  = BlockOutputs;
export type VjUsageBlockData     = BlockData;
export const VjUsageBlockPointer = BlockPointer;
